...
- Wrapped: './profile/', '%FB2K_PROFILE_PATH%\' or \'%PROFILE%\' special variables are allowed at latex CMD. Also improved input popup and readme to help with path CMD tweaking.
### Removed
### Fixed
