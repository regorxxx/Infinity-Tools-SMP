...
var newButtonsProperties = { // NOSONAR[global]
	...
	tags: ['Tags remap for lookups', JSON.stringify([
		...
		{ name: 'Similar artists', tf: [...new Set([globTags.sbdSimilarArtist, 'LASTFM_SIMILAR_ARTIST', globTags.lfmSimilarArtist, globTags.lbSimilarArtist])], type: 'ARTIST' },
...
addButton({
	'Last.fm Tools': new ThemedButton({
		...
		icon: chars.lastFm,
		variables: {
			lastList: new LastList({ forcedQuery: newButtonsProperties.forcedQuery[1] }),
			bioSelectionMode: 'Prefer nowplaying',
			bioTags: {}
		},
