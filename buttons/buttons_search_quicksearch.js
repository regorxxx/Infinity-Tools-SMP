...
/* global MK_SHIFT:readable, VK_SHIFT:readable, globQuery:readable, globTags:readable, MF_STRING:readable, MF_GRAYED:readable, VK_CONTROL:readable */
...
addButton({
	'Quicksearch': new ThemedButton({
		coordinates: { x: 0, y: 0, w: _textWidth('Quicksearch', buttonsBar.config.font.text) + buttonsBar.config.buttonMargin, h: _scale(16, false) },
		text: 'Quicksearch',
		func: function (mask) {
			if (mask === MK_SHIFT) {
