...
if (!window.ScriptInfo.Name) { window.DefineScript('Show Duplicates Button', { author: 'regorxxx', features: { drag_n_drop: false } }); }
...
addButton({
	'Show Duplicates': new ThemedButton({
		coordinates: { x: 0, y: 0, w: _textWidth('Show duplicates', buttonsBar.config.font.text) + buttonsBar.config.buttonMargin, h: _scale(16, false) },
